...
if __name__ == '__main__':
    ...
    print(deg.value(), " Valor do pino de debug")
    ...
    if(deg.value() == 1):
        ...
        if machine.reset_cause() == machine.DEEPSLEEP_RESET:
            ...
            mp_esp = FaceI2C("/")                                 # mudar para /sd quando montar o filesystem   
            
            card_SD = OnSd("/")                                   # mudar para /sd quando montar o filesystem                                  
            ...
            card_SD.preeencheARQ(id_esp, AccX, AccY, AccZ, timer, corte)
